      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', gap: '2px' }}>
            <Typography sx={{ fontSize: '16px', width: '200px' }}>{t('Price_item')}:</Typography>
            <Typography sx={{ fontSize: '16px', width: '200px' }}>
              {formatNumberToLocal(dataOrder.totalPrice - dataOrder.deliveryMethod.price)} VND
            </Typography>
          </Box>
          <Box sx={{ display: 'flex', gap: '2px' }}>
            <Typography sx={{ fontSize: '16px', width: '200px' }}>{t('Price_shipping')}:</Typography>
            <Typography sx={{ fontSize: '16px', width: '200px' }}>
              {formatNumberToLocal(dataOrder.deliveryMethod.price)} VND
            </Typography>
          </Box>
          <Box sx={{ display: 'flex', gap: '2px' }}>
            <Typography sx={{ fontSize: '16px', width: '200px', fontWeight: 600 }}>{t('Sum_money')}:</Typography>
            <Typography sx={{ fontSize: '16px', width: '200px', fontWeight: 600, color: theme.palette.primary.main }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 4, mt: 6, justifyContent: 'flex-end' }}>
          ...
          {/* chưa thanh toán + đang đợi giao hàng => hủy */}
