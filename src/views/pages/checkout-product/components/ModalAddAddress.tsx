...
// ** Others
import { cloneDeep, seporationFullname, toFullName } from 'src/utils'
  ...
  const onSubmit = (data: any) => {
    if (!Object.keys(errors).length) {
      if (activeTab === 2) {
        ...
        //cái này để check cái đầu tiên
        // nếu là cái đầu tiên thì cái isHvaD này nó là false => thì chạy vào case dưới
        // thì cái isD sẽ là true => mặc định là cái đầu tiên

        const { firstName, lastName, middleName } = seporationFullname(data.fullName, i18n.language)
        if (isEdit.isEdit) {
          // edit
